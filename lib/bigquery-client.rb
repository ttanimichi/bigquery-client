...
require 'bigquery-client/attribute/date'
require 'bigquery-client/service/run_query'
require 'bigquery-client/service/insert_rows'
require 'bigquery-client/service/fetch_tables'
